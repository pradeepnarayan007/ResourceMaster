...
<form:form method="post" action="/Spring3HibernateIntegration/saveEmployeeDetails" modelAttribute="employee">
<input type="hidden" value="4" id="empId" name="empId">
<div> 
...
<label for="EmpId">EmpID</label> 
	<input name="empId" type="text" placeholder="Enter empID">
<!-- <div>  -->
